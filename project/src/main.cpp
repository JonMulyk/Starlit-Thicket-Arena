...
int main() {
    ...
    Shader shader2("basicShader", "project/assets/shaders/CameraShader.vert", "project/assets/shaders/FragShader.frag");
    ...
    Model redBrick(shader2, gold, "project/assets/models/box.obj");
